...
export const seedSystemPermissions = async () => {
  const systemPermissions = [
    ...
    // Permissões de Presença
    {
      ...
      description: 'Permite criar registros de presença',
      module: 'attendance',
      isSystem: true,
    },
    {
    ...
    {
      key: 'attendance.edit',
      name: 'Editar Presenças',
      description: 'Permite editar presenças',
      module: 'attendance',
      isSystem: true,
    },
    {
      key: 'attendance.delete',
      name: 'Deletar Presenças',
      description: 'Permite deletar presenças',
      module: 'attendance',
      isSystem: true,
    },
    ...
    },
    {
      ...
      description: 'Permite editar certificados',
      module: 'certificate',
      isSystem: true,
    },
    {
      key: 'certificate.delete',
      name: 'Deletar Certificados',
      description: 'Permite deletar certificados',
      module: 'certificate',
      isSystem: true,
    },
    // Permissões de Squad
    {
      key: 'squad.create',
      name: 'Criar Squads',
      description: 'Permite criar novos squads',
      module: 'squad',
      isSystem: true,
    },
    {
      key: 'squad.view',
      name: 'Visualizar Squads',
      description: 'Permite visualizar squads',
      module: 'squad',
      isSystem: true,
    },
    {
      key: 'squad.edit',
      name: 'Editar Squads',
      description: 'Permite editar squads',
      module: 'squad',
      isSystem: true,
    },
    {
      key: 'squad.delete',
      name: 'Deletar Squads',
      description: 'Permite deletar squads',
      module: 'squad',
      isSystem: true,
    },
    ...
    {
      key: 'academicLeague.view',
      name: 'Visualizar Ligas',
      description: 'Permite visualizar ligas acadêmicas',
      module: 'academicLeague',
      isSystem: true,
    },
    {
      key: 'academicLeague.edit',
      name: 'Editar Ligas',
      description: 'Permite editar ligas acadêmicas',
      module: 'academicLeague',
      isSystem: true,
    },
    {
      key: 'academicLeague.delete',
      name: 'Deletar Ligas',
      description: 'Permite deletar ligas acadêmicas',
      module: 'academicLeague',
      isSystem: true,
    },
    // Permissões de Associação a Liga
    {
      key: 'leagueMembership.create',
      name: 'Criar Associações',
      description: 'Permite criar associações de usuários a ligas',
      module: 'leagueMembership',
      isSystem: true,
    },
    {
      key: 'leagueMembership.view',
      name: 'Visualizar Associações',
      description: 'Permite visualizar associações de usuários a ligas',
      module: 'leagueMembership',
      isSystem: true,
    },
    {
      key: 'leagueMembership.edit',
      name: 'Editar Associações',
      description: 'Permite editar associações de usuários a ligas',
      module: 'leagueMembership',
      isSystem: true,
    },
    {
      key: 'leagueMembership.delete',
      name: 'Deletar Associações',
      description: 'Permite deletar associações de usuários a ligas',
      module: 'leagueMembership',
      isSystem: true,
    },
    // Permissões de Universidade
    {
      key: 'university.create',
      name: 'Criar Universidades',
      description: 'Permite criar novas universidades',
      module: 'university',
      isSystem: true,
    },
    {
      key: 'university.view',
      name: 'Visualizar Universidades',
      description: 'Permite visualizar universidades',
      module: 'university',
      isSystem: true,
    },
    {
      ...
      description: 'Permite editar universidades',
      module: 'university',
      isSystem: true,
    },
    {
      key: 'university.delete',
      name: 'Deletar Universidades',
      description: 'Permite deletar universidades',
      module: 'university',
      isSystem: true,
    },
    // Permissões de Tarefas
    {
      key: 'task.create',
      name: 'Criar Tarefas',
      description: 'Permite criar novas tarefas',
      module: 'task',
      isSystem: true,
    },
    {
    ...
    },
    {
      key: 'task.edit',
      name: 'Editar Tarefas',
      description: 'Permite editar tarefas',
      module: 'task',
      isSystem: true,
    },
    {
      ...
      description: 'Permite deletar tarefas',
      module: 'task',
      isSystem: true,
    },
